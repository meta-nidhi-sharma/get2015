...
<body> 
	...
	<center>
		<button id="buttonAdmin" onclick="location.href='login_page.jsp'" name="adminButton" ">ADMIN</button>
		<button id="buttonUser" onclick="location.href='admin_page.jsp'" name="userButton" ">USER</button><br/><br/>
		</center>
