...
SELECT DISTINCT titles.title_name,books.purchase_dt,books.price
FROM 
titles 
INNER JOIN
books
...
SELECT book_issue.issue_date,book_issue.accession_no,book_issue.member_id,book_issue.due_dt,
members.member_name,members.addressline1,members.addressline2,members.category
FROM book_issue
INNER JOIN
members
ON
